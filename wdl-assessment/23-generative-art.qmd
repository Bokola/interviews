...
::: incremental
-   Course and TA evaluations are open, please fill them out.

    -   Want to nominate a TA as "TA of the Year"?
        Send an email to dus\@stat.duke.edu with your nomination.

-   Any volunteers for live code review of project on Tuesday?
    DM me on Slack with a link to your repo.
    First come, first served-ish.

-   Award ceremony on Tuesday!

-   Your project needs a live "homepage":

    -   Quarto website like in Project 1

    -   An app/dashboard/etc.

    -   A pkgdown site

    If you need help building this, don't leave it to the last minute!
    And if building a website, reach out to me to turn on hosting for you.
:::

## From last time...

<https://vizdata.org/slides/22/22-tables.html#/ae-17-task-3>
...
::: aside
New York Public Library, [Generative eBook Covers](https://www.nypl.org/blog/2014/09/03/generative-ebook-covers).
September 3, 2014.
:::
